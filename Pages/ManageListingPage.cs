   ...
   public class ManageListingPage
    {
        public void EditingSteps(IWebDriver driver)
        {
            ...
            titleTextBox.Clear();
            Wait.WaitToBeClickable(driver, "XPath", "//*[@id='service-listing-section']/div[2]/div/form/div[1]/div/div[2]/div/div[1]/input", 3);
                                                    //*[@id="service-listing-section"]/div[2]/div/form/div[1]/div/div[2]/div/div[1]/input
            string title = ExcelOperations.ReadData(1, "Title");
            titleTextBox.SendKeys("Update Marketing");
            ...
            descriptionTextBox.SendKeys("Marketing information details");
            ...
            categoryselect.SelectByText("Business");
            ...
            Wait.WaitToBeClickable(driver, "XPath", "//*[@id='service-listing-section']/div[2]/div/form/div[3]/div[2]/div/div[2]/div[1]/select/option[3]", 2);
            IWebElement subcategory1 = driver.FindElement(By.XPath("//*[@id='service-listing-section']/div[2]/div/form/div[3]/div[2]/div/div[2]/div[1]/select/option[3]"));
            subcategory1.Click();
            //categoryselect.SelectByText("Presentations");
            ...
            skillExchange.SendKeys("EmailMarketing");
